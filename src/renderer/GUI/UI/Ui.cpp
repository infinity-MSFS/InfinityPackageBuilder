...
namespace InfinityRenderer::UI {
    ...
    void DrawButtonImage(const std::shared_ptr<Image> &imageNormal, const std::shared_ptr<Image> &imageHovered,
                         const std::shared_ptr<Image> &imagePressed, const ImU32 tintNormal, const ImU32 tintHovered,
                         const ImU32 tintPressed, const ImVec2 rectMin, const ImVec2 rectMax) {
        auto *drawList = ImGui::GetForegroundDrawList();
        if (ImGui::IsItemActive())
            drawList->AddImage(imagePressed->GetDescriptorSet(), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1),
                               tintPressed);
    ...
    void DrawButtonImage(const std::shared_ptr<Image> &imageNormal, const std::shared_ptr<Image> &imageHovered,
        ...
        DrawButtonImage(imageNormal, imageHovered, imagePressed, tintNormal, tintHovered, tintPressed, rectangle.Min,
                        rectangle.Max);
    };

    void DrawButtonImage(const std::shared_ptr<Image> &image, const ImU32 tintNormal, const ImU32 tintHovered,
                         const ImU32 tintPressed, const ImVec2 rectMin, const ImVec2 rectMax) {
    ...
    void DrawButtonImage(const std::shared_ptr<Image> &image, const ImU32 tintNormal, const ImU32 tintHovered,
                         const ImU32 tintPressed) {
        DrawButtonImage(image, image, image, tintNormal, tintHovered, tintPressed, ImGui::GetItemRectMin(),
    ...
    void RenderWindowOuterBorders(ImGuiWindow *window) {
        ...
        auto GetResizeBorderRect = [](ImGuiWindow *window, const int border_n, const float perp_padding,
    ...
    bool UpdateWindowManualResize(ImGuiWindow *window, ImVec2 &newSize, ImVec2 &newPosition) {
        ...
        auto CalcResizePosSizeFromAnyCorner =
                [CalcWindowSizeAfterConstraint](ImGuiWindow *window, const ImVec2 &corner_target,
        ...
        static const float WINDOWS_HOVER_PADDING =
                4.0f; // Extend outside window for hovering/resizing (maxxed with TouchPadding) and inside windows for
    ...
    void EndMenubar() {
        ...
        window->DC.MenuBarOffset.x =
                window->DC.CursorPos.x - window->Pos.x; // Save horizontal position so next append can reuse it. This is
    ...
    void DrawBorder(ImRect rect, float thickness, float rounding, float offsetX, float offsetY) {
        ...
        drawList->AddRect(min, max, ImGui::ColorConvertFloat4ToU32(ImGui::GetStyleColorVec4(ImGuiCol_Border)), rounding,
                          0, thickness);
    };
} // namespace InfinityRenderer::UI
