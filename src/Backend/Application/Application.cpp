...
#include "Frontend/Resources/Fonts/Roboto-Bold.h"
#include "Frontend/Resources/Fonts/Roboto-Italic.h"
#include "Frontend/Resources/Fonts/Roboto-Regular.h"
...
namespace Infinity {
    ...
    void Application::UI_DrawTitleBar(float &out_title_bar_height) {
        ...
        bgDrawList->AddRectFilled(title_bar_min, title_bar_max, Colors::Theme::title_bar);
